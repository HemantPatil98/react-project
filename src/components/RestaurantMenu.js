    ...
    <div className="body-container">
      <div className="rest-list-main-container flex-column align-items-center">
        ...
        <div className="resDetails">
          <b className="ratingAndPrice flex-row">
            <StarsRounded /> {avgRating} ({totalRatingsString}) - {costForTwo}
          </b>
          <p className="cuesine">{cuisines.join(", ")}</p>
        </div>
        <div className="menuHeader flex-row justify-content-center align-items-center">
          Menu <RestaurantMenuRounded />
        </div>
